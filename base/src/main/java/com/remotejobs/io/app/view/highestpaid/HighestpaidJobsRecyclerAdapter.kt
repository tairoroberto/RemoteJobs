package com.remotejobs.io.app.view.highestpaid
 ...
 */
class HighestpaidJobsRecyclerAdapter(private val context: Context?,
                                     private var list: MutableList<Job>,
                                     private val onClick: (job: Job, imageView: ImageView) -> Unit) : RecyclerView.Adapter<HighestpaidJobsRecyclerAdapter.ViewHolder>() {
